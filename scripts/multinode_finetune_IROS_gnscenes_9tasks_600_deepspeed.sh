#!/bin/bash
#SBATCH -J multinode_finetune_IROS_gnscenes_9tasks_600_deepspeed
#SBATCH -p efm_p
#SBATCH -N 4
...
export WANDB_RUN_ID="gr00t_finetune_IROS_gnscenes_9tasks_600_deepspeed"
...
srun torchrun \
  ...
  scripts/gr00t_finetune_multinode.py \
    ...
    data/demonstrations_lerobot/IROS_C_RoboTiq_lerobot/waste_split_split_1_h264 \
    data/demonstrations_lerobot/IROS_C_RoboTiq_lerobot/waste_split_split_3_h264 \
    ...
    --output-dir ./logs/multinode_finetune_IROS_gnscenes_9tasks_600_deepspeed \
    --batch_size 48 \
    --save-steps 15000 \
    --max-steps 400000
