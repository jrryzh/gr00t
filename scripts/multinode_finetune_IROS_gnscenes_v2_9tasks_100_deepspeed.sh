#!/bin/bash
#SBATCH -J IROS_v2_9tasks_100_deepspeed
#SBATCH -p efm_p
#SBATCH -N 4
...
export WANDB_RUN_ID="gr00t_finetune_IROS_gnscenes_v2_9tasks_100_deepspeed"
...
srun torchrun \
  ...
  scripts/gr00t_finetune_multinode.py \
    ...
    --output-dir ./logs/multinode_finetune_IROS_gnscenes_v2_9tasks_100_deepspeed \
    --batch_size 48 \
    --save-steps 5000 \
    --max-steps 30000
