#!/bin/bash
#SBATCH -J multinode_finetune_IROS_gnscenes_9tasks_300_deepspeed
#SBATCH -p efm_p
#SBATCH -N 2
...
export WANDB_RUN_ID="gr00t_finetune_IROS_gnscenes_9tasks_300_deepspeed"
...
srun torchrun \
  ...
  scripts/gr00t_finetune_multinode.py \
    ...
    --output-dir ./logs/multinode_finetune_IROS_gnscenes_9tasks_300_deepspeed \
    --batch_size 48 \
    --save-steps 10000 \
    --max-steps 200000
