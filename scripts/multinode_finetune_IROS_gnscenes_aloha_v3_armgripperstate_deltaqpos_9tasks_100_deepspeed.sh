...
export WANDB_RUN_ID="gr00t_finetune_IROS_gnscenes_aloha_v3_armgripperstate_deltaqpos_9tasks_deepspeed"
...
srun torchrun \
  ...
  scripts/gr00t_finetune_multinode.py \
    ...
    data/demonstrations_lerobot/aloha_v3_final/aloha_object_select3_split_1_h264_v3_final \
    data/demonstrations_lerobot/aloha_v3_final/aloha_object_select4_split_1_h264_v3_final \
    --data_config aloha_gripper_arm_state \
    --output-dir ./logs/multinode_finetune_IROS_gnscenes_aloha_v3_armgripperstate_deltaqpos_9tasks_100_deepspeed \
    --batch_size 48 \
    --save-steps 5000 \
    --max-steps 50000